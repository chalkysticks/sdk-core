...
export declare function normalizeDateString(input: string): Date | null;
...
export declare function toDate(input: TimeInput): Date | null;
export declare function toISOString(input: TimeInput): string;
export declare function formatTime(dateInput: Date | string, format?: string): string;
export {};
